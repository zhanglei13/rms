...
<html>
	<head>	
		...
		<%@include file="/WEB-INF/view/common/importJs.jsp" %> 
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<img class="logo"></img>
									<span class="red">RMS</span>
									<span class="white" id="id-text2">Admin</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy;lenovo</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											<h4 id="tip" class="header blue lighter bigger">
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			$(function($){
				var tip=tools.getQueryString("info");
