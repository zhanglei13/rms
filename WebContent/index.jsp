		...
		<div region="west" iconCls="icon-add" split="true" title="Menu"
			...
			<div id="aa" class="easyui-accordion" fit=true>
				<div title="Profile" style="overflow: auto; padding: 10px;">
					<a title="${ctp}/profile.jsp">Profile</a> <br />
				</div>
				<div title="Personal Workload" selected="true"
					style="padding: 10px;">
					<a title="${ctp}/workload.jsp">Workload</a> <br />
				</div>
				<div id="" approval" title="Workload Approval" selected="fasle"
					style="padding: 10px;">
					<a id="itleader" title="${ctp}/itleader_approval.jsp">IT Leader</a> <br />
					<a id="linmanager" title="${ctp}/linemanager_approval.jsp">Line
						Manager</a> <br />
				</div>
